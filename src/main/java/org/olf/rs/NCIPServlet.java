...
public class NCIPServlet extends HttpServlet {
     ...
     */
    protected MappedMessageHandler messageHandler;
    ...
    public NCIPServlet(Properties properties) throws ToolkitException {
        ...
        this.messageHandler = (MappedMessageHandler) MessageHandlerFactory.buildMessageHandler(properties);
    ...
    public NCIPServlet(CoreConfiguration coreConfig) throws ToolkitException {
        ...
        this.messageHandler = (MappedMessageHandler) MessageHandlerFactory.buildMessageHandler(coreConfig.getMessageHandlerConfiguration());
     ...
     */
    public void setMessageHandler(MappedMessageHandler messageHandler) {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                //getServletContext().getAttribute("content");
            ...
            MockRemoteServiceManager folioRemoteServiceManager = new MockRemoteServiceManager();
            folioRemoteServiceManager.setDbConnection((Connection) getServletContext().getAttribute("db"));
